package map;
	...
	public class Linked_Hashmap_Accessorder {
		...
		public static void main(String[] args) {
			...
			int key = 1000;
			System.out.printf("2. Accessting value at key: ",+key+" is "+mapVehicleNoAndOwner.get(key));
			
			key = 3000;
			System.out.printf("3. Accessting value at key:" +key+" is "+mapVehicleNoAndOwner.get(key));
